...
import { DashboardSectionSlider } from '../sections';
...
describe('<DashboardSectionSlider>', () => {
  it('renders', () => {
    ...
    const rowBlockHeader = getByTestId('dashboard-section-header');
  ...
  it('renders without data', () => {
    const { getByTestId, getByRole } = render(<DashboardSectionSlider />);
